...
class Ec2Stack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        vpc_id=cdk.Fn.import_value("Demo-VPCID")
        vpc=ec2.Vpc.from_lookup(self, id='vpc', vpc_id='vpc-0b56e8f5cb497177b')
        private_security_group_id = cdk.Fn.import_value("Demo-PrivateSecurityGroupID")

        ec2.Instance(self, "AppServer",
            vpc=vpc,
            vpc_subnets=ec2.SubnetSelection(
                subnets=[
                    ec2.Subnet.from_subnet_attributes(
                        self, 'subnetid1',
                        subnet_id=cdk.Fn.import_value("Demo-PrivateSubnetID"),
